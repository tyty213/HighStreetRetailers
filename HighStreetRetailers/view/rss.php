...
<h1>RSS Feed of our articles!</h1>
<h3>If you want to add this to your site use the url 'http://itstyl.org/controller/feed.php'</h3>
<!-- start sw-rss-feed code --> 
<script type="text/javascript"> 
<!-- 
rssfeed_url = new Array(); 
rssfeed_url[0]="http://itstyl.org/controller/feed.php";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "921d35b299e4d398b4c613f92cd95e70"; 
//--> 
</script> 
